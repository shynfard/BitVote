...
// list of commands that we recognize, but for which bitVote has no support because
...
func jsonAuthFail(w http.ResponseWriter) {
	w.Header().Add("WWW-Authenticate", `Basic realm="bitVote RPC"`)
...
func genCertPair(certFile, keyFile string) error {
	...
	org := "bitVote autogenerated cert"
